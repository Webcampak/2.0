...
*/
/**
 * @class Configwatermarksizes
 * A simple application controller extension
 */
class Statssourcepicturesizes extends ApplicationController {
    /**
     * view
	...
	public function view() {
		...
		if ($userAuth->isAllowedToAccessPage("auth.stats.pictures.size") == true) {
			$res = new Response();
			$res->success = true;
			$res->message = "Loaded data";
			$res->data = Statssourcepicturesize::all();
			return $res->to_json();
		} else {

...
*/
/**
 * @class Cloudconfigwatermarkfiles
 * A simple application controller extension
 */
class Cloudconfigwatermarkfiles extends ApplicationController {
    /**
     * view
	...
	public function view() {
		...
		if ($userAuth->isAllowedToAccessPage("auth.config.cloud.read") == true) {
			...
			$res->data = Cloudconfigwatermarkfile::all();
			return $res->to_json();
		} else {
			Log::debug("Log: /remote/lib/controllers/cloudconfigwatermarkfiles.php - view() - User not allowed to access 'auth.config.cloud.read' page");			
		}
	}
    /**
     * create

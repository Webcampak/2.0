...
*/
console.log('Log: Load: Webcampak.store.configuration.Advanced');
Ext.define('Webcampak.store.configuration.Advanced', {
	extend: 'Ext.data.Store',
	model: 'Webcampak.model.configuration.Advanced',
//	autoLoad: true,
	autoSync: true,    
	proxy: {  	
		type: 'rest',
		url: '/interface/app.php/configadvanceds',

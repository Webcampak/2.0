...
*/
console.log('Log: Load: Webcampak.store.configuration.FTPServer');
Ext.define('Webcampak.store.configuration.FTPServer', {
	extend: 'Ext.data.Store',
	model: 'Webcampak.model.configuration.FTPServer',
//	autoLoad: true,
	autoSync: true,    
	proxy: {  	
		type: 'rest',
		url: '/interface/app.php/configftpservers',

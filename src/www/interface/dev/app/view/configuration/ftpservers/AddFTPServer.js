...
*/
console.log('Log: Load: Webcampak.view.configuration.ftpservers.AddFTPServer');
Ext.define('Webcampak.view.configuration.ftpservers.AddFTPServer' ,{
	extend: 'Ext.window.Window', 
	alias: 'widget.configurationftpserversaddftpserver',

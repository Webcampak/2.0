...
*/
console.log('Log: Load: Webcampak.view.configuration.postprodvideos.Text');
Ext.define('Webcampak.view.configuration.postprodvideos.Text' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.configpostprodvideostext',

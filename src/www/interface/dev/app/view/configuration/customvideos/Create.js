...
*/
console.log('Log: Load: Webcampak.view.configuration.customvideos.Create');
Ext.define('Webcampak.view.configuration.customvideos.Create' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.configcustomvideoscreate',

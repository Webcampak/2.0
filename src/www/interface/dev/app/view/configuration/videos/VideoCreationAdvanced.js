...
*/
console.log('Log: Load: Webcampak.view.configuration.videos.VideoCreationAdvanced');
Ext.define('Webcampak.view.configuration.videos.VideoCreationAdvanced' ,{

	extend: 'Ext.form.FieldSet',
	alias: 'widget.configvideosvideocreationadvanced',
	...
	items   : [{
		...
		items   : [
			...
			{width: 60,																xtype: 'label',			html: i18n.gettext('Crop:'), 	padding: 2	}, 	
		...
		layout: {type:'hbox',	align: 'stretch',	pack: 'start'},				
		items   : [
			{flex: 1,																xtype: 'label',			html: i18n.gettext('Custom:'), 	padding: 2	},
			{width: 50,																xtype: 'label',			html: i18n.gettext('Bitrate:'), 	padding: 2	}, 			
			{width: 55,	name: 'cfgvideocodecH264custombitrate', 		xtype: 'numberfield',	minValue: 1000,	maxValue: 10000},
			{width: 40,																xtype: 'label',			html: i18n.gettext('Size:'), 	padding: 2	}, 	
			{width: 55,	name: 'cfgvideocodecH264customwidth', 			xtype: 'numberfield',	minValue: -10000,	maxValue: 10000},
			{width: 10,																xtype: 'label',			html: 'x', 	padding: 2	}, 
			{width: 55,	name: 'cfgvideocodecH264customheight', 		xtype: 'numberfield',	minValue: -10000,	maxValue: 10000},		
			{width: 60,																xtype: 'label',			html: i18n.gettext('Crop:'), 	padding: 2	}, 	
			{width: 55,	name: 'cfgvideocodecH264customcropwidth', 	xtype: 'numberfield',	minValue: -10000,	maxValue: 10000},	
			{width: 10,																xtype: 'label',			html: ':', 	padding: 2	}, 	
			{width: 55,	name: 'cfgvideocodecH264customcropheight', 	xtype: 'numberfield',	minValue: -10000,	maxValue: 10000},	
			{width: 10,																xtype: 'label',			html: ':', 	padding: 2	}, 	
			{width: 55,	name: 'cfgvideocodecH264customcropx', 			xtype: 'numberfield',	minValue: -10000,	maxValue: 10000},	
			{width: 10,																xtype: 'label',			html: ':', 	padding: 2	}, 	
			{width: 55,	name: 'cfgvideocodecH264customcropy', 			xtype: 'numberfield',	minValue: -10000,	maxValue: 10000}
		]					
	}]
});

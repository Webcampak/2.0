...
*/
console.log('Log: Load: Webcampak.view.configuration.videos.VideoCreation');
Ext.define('Webcampak.view.configuration.videos.VideoCreation' ,{

	extend: 'Ext.form.FieldSet',
	alias: 'widget.configvideosvideocreation',
	...
	items   : [{
		...
		layout: {type:'hbox',	align: 'stretch',	pack: 'start'},				
		items   : [
			{flex: 1,							name: 'cfgvideocodecH264customcreate',		xtype: 'checkboxfield',	uncheckedValue: 'off',	inputValue: 'on', fieldLabel: i18n.gettext('H. 264 (Custom)')}, 
			{width: 180,																				xtype: 'label',			html: i18n.gettext('H.264, custom settings.'), 	padding: 2	}, 
			{width: 100, labelWidth: 70,	name: 'cfgvideocodecH264customcreateflv',	xtype: 'checkboxfield',	uncheckedValue: 'off',	inputValue: 'on', fieldLabel: i18n.gettext('Web (MP4)')												}, 
			{width: 160,						name: 'cfgvideocodecH264customfps', 		xtype: 'numberfield', 	fieldLabel: i18n.gettext('FPS'), minValue: 1,	maxValue: 100}
		]					
	}]
});

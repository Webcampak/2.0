...
*/
console.log('Log: Load: Webcampak.view.configuration.videos.FTP');
Ext.define('Webcampak.view.configuration.videos.FTP' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.configvideosftp',
	...
	items   : [{
			...
			items   : [
				...
				{flex: 1,		xtype: 'configpicturesftpserver', 	name: 'cfgftpmainserveraviid'}, 
			...
			items   : [
				...
				{flex: 1,		xtype: 'configpicturesftpserver', 	name: 'cfgftpmainservermp4id'}, 
				{width: 100,	xtype: 'label',							html: i18n.gettext('Number of retry:'), 	padding: 2	}, 						
			...
			items   : [
				...
				{flex: 1,		xtype: 'configpicturesftpserver', 	name: 'cfgftphotlinkserveraviid'}, 
				{width: 100,	xtype: 'label',							html: i18n.gettext('Number of retry:'), 	padding: 2	}, 						
			...
			items   : [
				...
				{flex: 1,		xtype: 'configpicturesftpserver', 	name: 'cfgftphotlinkservermp4id'}, 
				{width: 100,	xtype: 'label',							html: i18n.gettext('Number of retry:'), 	padding: 2	}, 						

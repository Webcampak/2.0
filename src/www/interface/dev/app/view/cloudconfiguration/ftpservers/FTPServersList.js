...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.ftpservers.FTPServersList');
Ext.define('Webcampak.view.cloudconfiguration.ftpservers.FTPServersList' ,{
	extend: 'Ext.grid.Panel',
	alias : 'widget.cloudconfigurationftpserverslist',

	store: 'cloudconfiguration.FTPServer',
	autoScroll: true,
	columns: [

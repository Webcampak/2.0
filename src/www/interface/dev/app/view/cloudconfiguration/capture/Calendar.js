...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.capture.Calendar');
Ext.define('Webcampak.view.cloudconfiguration.capture.Calendar' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigcapturecalendar',

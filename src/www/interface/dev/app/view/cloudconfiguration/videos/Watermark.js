...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.videos.Watermark');
Ext.define('Webcampak.view.cloudconfiguration.videos.Watermark' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigvideoswatermark',

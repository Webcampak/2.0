...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.videos.PreProcess');
Ext.define('Webcampak.view.cloudconfiguration.videos.PreProcess' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigvideospreprocess',

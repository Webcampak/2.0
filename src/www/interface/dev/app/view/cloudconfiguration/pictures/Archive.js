...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.pictures.Archive');
Ext.define('Webcampak.view.cloudconfiguration.pictures.Archive' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigpicturesarchive',

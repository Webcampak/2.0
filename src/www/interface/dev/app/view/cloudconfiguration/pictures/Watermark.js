...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.pictures.Watermark');
Ext.define('Webcampak.view.cloudconfiguration.pictures.Watermark' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigpictureswatermark',
	...
	items   : [{
		...
		xtype: 'cloudconfigpictureswatermarkfile'
	},	{
		labelWidth: 180,		
		flex: 1,				

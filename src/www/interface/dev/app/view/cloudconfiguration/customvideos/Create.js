...
*/
console.log('Log: Load: Webcampak.view.cloudconfiguration.customvideos.Create');
Ext.define('Webcampak.view.cloudconfiguration.customvideos.Create' ,{
	extend: 'Ext.form.FieldSet',
	alias: 'widget.cloudconfigcustomvideoscreate',

	layout: 'fit',
	items   : [{
		labelWidth: 250,
		flex: 1,				
		name: 'cfgcustomvidname',
		xtype: 'textfield',
		vtype: 'alphanum',

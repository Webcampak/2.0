...
*/
console.log('Log: Load: Webcampak.view.permissions.groups.GroupMembers');
Ext.define('Webcampak.view.permissions.groups.GroupMembers' ,{
	extend: 'Ext.grid.Panel',
	alias : 'widget.groupmembers',
   multiSelect: true,
	viewConfig: {
		plugins: {
			ptype: 'gridviewdragdrop',
			dragText: i18n.gettext('Drag users to add them to the group'),
			dragGroup: 'groupmembersDDGroup',
			dropGroup: 'groupavailableusersDDGroup'
		}
	},
   
	store: 'permissions.groups.GroupMembers',
	autoScroll: true,
	minHeight: 50,
	border: 0,
	columns: [

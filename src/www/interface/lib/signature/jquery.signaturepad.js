...
function SignaturePad (selector, options) {
	//console.log("Log: SignaturePad L29");
  /**
...
$.fn.signaturePad = function (options) {
  var api = null
	//console.log("Log: signaturePad - 1/ Create the plugin");
	//console.log(this);
  this.each(function () {
	//console.log("Log: signaturePad - 1.a/ this.each");  	
    if (!$.data(this, 'plugin-signaturePad')) {
		//console.log("Log: signaturePad - 2.1/ Init option");    	
      api = new SignaturePad(this, options)
      api.init()
      $.data(this, 'plugin-signaturePad', api)
    } else {
		//console.log("Log: signaturePad - 2.2/ Update option");    	    	

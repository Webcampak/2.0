     ...
     */
	console.log('Log: Load: WebcampakMobile.view.pictures.FreeDrawComponen');   
    Ext.define('WebcampakMobile.view.pictures.FreeDrawComponent', {
                ...
                'touchstart': function (e) {
                    if (!sprite) {
                        ...
                        sprite = cmp.getSurface('overlay').add({
                            ...
                            lineCap: 'round',
                            lineJoin: 'round',
                            strokeStyle: new Ext.draw.Color(1, 255, 1)
                        });
                        old1 = old2 = p;
